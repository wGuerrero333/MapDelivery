...
marker.bindPopup("<b>Tu ubicacion!</b><br> click ME.").openPopup();
circle.bindPopup("Ubicación en radio. You clicked ME.");
polygon.bindPopup("Ubicación en Zona. you cliked ME.");
